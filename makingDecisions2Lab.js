...
} else { myFacoriteNumbers.push(someNum + myFavoriteNumbers[5])
...
for(let i = 0; i < listOfNumbers.length; i++) {
  if(listOfNumbers[i] % 3 === 0) {
    console.log(`${i + 1} is divisible by 3.`)
  }
}
